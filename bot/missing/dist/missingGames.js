...
(async () => {
    ...
    const result = await pool.query({
        text: 'select sg.game_id from stream_game sg where sg.game_id != 0 AND sg.game_id not in ( SELECT g.game_id from game g) group by sg.game_id',
        rowMode: 'array',
    });
