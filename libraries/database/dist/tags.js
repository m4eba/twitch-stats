...
export async function insertUpdateTags(pool, data, time) {
    if (data.length === 0)
        return Promise.resolve(undefined);
    const insert = buildMultiInsert('INSERT INTO tags (tag_id,is_auto,localization_names,localization_descriptions,updated_at) VALUES ', '$1,$2,$3,$4,$5', data, (d) => [
        d.tag_id,
        d.is_auto,
